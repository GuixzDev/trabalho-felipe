...
public class Loja {
    ...
    public static void exibirResumo(Cliente cliente) {
        ...
        System.out.println("Total de computadores: " + cliente.getComputadores().size());

        if (cliente.getComputadores().isEmpty()) {
    ...
    public static Computador criarPromocao1() {
        Computador pc = new Computador("Apple", 4500f);
    ...
    public static Computador criarPromocao2() {
        Computador pc = new Computador("Samsung", 3200f);
    ...
    public static Computador criarPromocao3() {
        Computador pc = new Computador("Dell", 5800f);
